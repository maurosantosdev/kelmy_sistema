<?php
// Script de debug simplificado para o contrato
...
if (!isset($_SESSION['user_id'])) {
    $_SESSION['user_id'] = 106; // Usando o ID do usuário encontrado anteriormente
    echo "INFO: Simulando sessão para usuário ID: 106\n";
}
...
echo "<h2>DEBUG SIMPLIFICADO DO CONTRATO</h2>\n";
